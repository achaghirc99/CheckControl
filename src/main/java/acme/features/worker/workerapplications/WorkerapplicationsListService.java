...
@Service
public class WorkerapplicationsListService implements AbstractListService<Worker, Application> {
	...
	public Collection<Application> findMany(final Request<Application> request) {
		...
		result = this.repository.findManyWorkerapplications(principal.getActiveRoleId());
