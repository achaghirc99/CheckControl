...
@Service
public class AdministratorRegistertDeleteService implements AbstractDeleteService<Administrator, Register> {
	...
	@Override
	public void delete(final Request<Register> request, final Register entity) {
		assert request != null;
		assert entity != null;
