...
@Service
public class AdministratorRegisterListServiceTop implements AbstractListService<Administrator, Register> {

	@Autowired
	AdministratorRegisterRepository repository;


	// AbstractListService<Administrator, Register> interface --------------
