...
<acme:form readonly = "true">
	<acme:form-textbox code="anonymous.announcement.form.label.title" path="title"  placeholder="Sample Announcement"/>
	...
	<acme:form-textarea code="anonymous.announcement.form.label.text" path="text" placeholder="---"/>
