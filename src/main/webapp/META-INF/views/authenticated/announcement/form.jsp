...
<acme:form readonly = "true">
	<acme:form-textbox code="authenticated.announcement.form.label.title" path="title" placeholder="Sample Announcement"/>
	...
	<acme:form-textarea code="authenticated.announcement.form.label.text" path="text" placeholder="----"/>
